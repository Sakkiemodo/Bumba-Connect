                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 right-side">
                                ...
                                <div class="description text-right">
                                    <?= character_limiter(strip_tags($article['basic_description']), 1500) ?>
                                </div>
            ...
            <?php } if ($shippingOrder != 0 && $shippingOrder != null) { ?>
                <div class="filter-sidebar">
                    ...
                    <div class="oaerror info">
                        <strong><?= lang('promo') ?></strong> - <?= str_replace(array('%currency%', '%price%'), array($shippingOrder, CURRENCY), lang('freeShipping')) ?>!
                    </div>
                </div>
            <?php } ?>
        </div>
